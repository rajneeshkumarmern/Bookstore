...
export default function Home({ searchQuery }) {
  ...
  return (
        ...
        <div className="relative mx-auto w-full max-w-6xl px-4 py-10 sm:px-6 sm:py-12 lg:py-14">
          ...
          {showAddForm && (
            <div className="mt-8 glass-panel-soft rounded-3xl p-8 shadow-glass-lg">
              <h3 className="text-xl font-semibold text-white mb-6">Add New Book</h3>
              <form onSubmit={handleAddBook} className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <input
                  ...
                  required
                  className="rounded-xl border border-white/10 bg-white/[0.06] px-4 py-3 text-white placeholder-white/50 outline-none ring-amber-400/30 transition-all duration-200 focus-visible:ring-2"
                />
                <input
                  type="text"
                  placeholder="Author"
                ...
                <select
                  ...
                  required
                  className="rounded-xl border border-white/10 bg-white/[0.06] px-4 py-3 text-white outline-none ring-amber-400/30 transition-all duration-200 focus-visible:ring-2"
                >
                ...
                <textarea
                  ...
                  className="rounded-xl border border-white/10 bg-white/[0.06] px-4 py-3 text-white placeholder-white/50 outline-none ring-amber-400/30 transition-all duration-200 focus-visible:ring-2 sm:col-span-2"
                  rows="3"
                ></textarea>
                <button
                  type="submit"
      ...
      <section className="mx-auto w-full max-w-6xl flex flex-col px-4 py-8 sm:px-6 sm:py-6 lg:py-8">
        ...
        <div className="glass-panel-soft mt-8 rounded-3xl p-5 shadow-glass-lg sm:mt-10 sm:p-8">
          {loading ? (
            ...
            <div className="glass-panel-soft mx-auto mt-10 max-w-2xl rounded-3xl p-12 text-center shadow-glass-lg">
              ...
              <p className="mx-auto mt-4 max-w-lg text-sm leading-7 text-white/60">
                Try a different keyword or browse the collection to find books you love.
              </p>
              <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row sm:justify-center">
                ...
                {searchQuery ? (
                  <button
                    ...
                    className="inline-flex items-center justify-center rounded-full border border-white/10 bg-white/[0.05] px-6 py-3 text-sm font-semibold text-white transition-all duration-200 hover:border-white/20 hover:bg-white/[0.12] hover:shadow-lg active:scale-95"
                  >
                    Clear search
                  </button>
                ) : null}
